...
let cujren= "DGB"
let amount = amous*0.011/0.06633
...
Bot.setProperty("dgb"+user.telegramid)
...
let txurl2='<a href="https://tx.botdev.me/DGB/'+txn_id+'">'+txn_id+' </a>'
...
let tx89='<a href="https://tx.botdev.me/DGB/'+txn_id+'">'+txn_id+' </a>'
