...
if(dep_type=="dep1"){
Bot.run( {
    command: "/adc"+" "+am+" "+list+" "+sx+" "+cur+" "+"dep1",
    run_after: 60*60*daily_hour1,  
    chat_id: chat.id,  
    user_id: user.id  
} )
}else if(dep_type=="dep2"){
Bot.run( {
    command: "/adc"+" "+am+" "+list+" "+sx+" "+cur+" "+"dep2",
    run_after: 60*60*daily_hour2,  
    chat_id: chat.id,  
    user_id: user.id  
} )
}else if(dep_type=="dep3"){
Bot.run( {
    command: "/adc"+" "+am+" "+list+" "+sx+" "+cur+" "+"dep3",
...
if((dep_type=="dep1")||(dep_type=="dep2")||(dep_type=="dep3")){
