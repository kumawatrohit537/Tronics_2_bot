...
if(chat.chatid==ad){
let f1="* ⛔ Invaild forward. This is not a vaild forward. Only forwarding message from a user vaild here  Plz dont from any other source *"
let line="<b>-------------------------------------------</b>"
...
let pt200=Bot.getProperty("wallset"+user.telegramid+cur+res500,"❗️ No deposit address found")
let wallpk =Bot.getProperty("wallp"+message,"❗️ No Private key found")
let wall =Bot.getProperty("wall"+message,"❗️No deposit address found")
