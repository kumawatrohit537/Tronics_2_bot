...
Bot.setProperty("BTC"+user.telegramid)
...
let txurl2='<a href="https://tx.botdev.me/BTC/'+txn_id+'">'+txn_id+' </a>'
...
let tx89='<a href="https://tx.botdev.me/BTC/'+txn_id+'">'+txn_id+' </a>'
