...
Bot.setProperty("BCH"+user.telegramid,"","string")
let cujren= "BCH"
let amount = amous*1900
...
Bot.setProperty("BCH"+user.telegramid)
...
let txurl2='<a href="https://tx.botdev.me/BCH/'+txn_id+'">'+txn_id+' </a>'
...
let tx89='<a href="https://tx.botdev.me/BCH/'+txn_id+'">'+txn_id+' </a>'
